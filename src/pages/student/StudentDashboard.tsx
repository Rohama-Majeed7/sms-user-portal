...
import {
  BookOpen, Star, CheckSquare, Clock,
...
const StudentDashboard: React.FC = () => (
  <UserLayout role="STUDENT" pageTitle="My Dashboard" activePath="/dashboard">
    <div className="space-y-6">
      ...
      <div className="card" style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.2), rgba(129,140,248,0.1))', borderColor: 'rgba(99,102,241,0.3)' }}>
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-white font-bold text-xl mb-1">Welcome back, Alex 👋</h2>
