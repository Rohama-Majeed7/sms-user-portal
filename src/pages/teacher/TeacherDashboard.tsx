...
const pendingTasks = [
  ...
  { task: 'Meeting Preparation', due: 'Monday', priority: 'Low' },
];

const TeacherDashboard: React.FC = () => (
  <UserLayout role="TEACHER" pageTitle="Teacher Dashboard" activePath="/teacher-dashboard">
    <div className="space-y-6">
      ...
      <div className="card" style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.2), rgba(52,211,153,0.1))', borderColor: 'rgba(16,185,129,0.3)' }}>
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-white font-bold text-xl mb-1">Good morning 🌿</h2>
